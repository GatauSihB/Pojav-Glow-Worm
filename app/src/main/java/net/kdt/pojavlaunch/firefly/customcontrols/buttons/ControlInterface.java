package net.kdt.pojavlaunch.firefly.customcontrols.buttons;

import static android.view.View.GONE;
import static android.view.View.VISIBLE;
import static net.kdt.pojavlaunch.firefly.prefs.LauncherPreferences.PREF_BUTTONSIZE;
...
public interface ControlInterface extends View.OnLongClickListener, GrabListener {
    ...
    default boolean canSnap(ControlInterface button) {
        ...
        return !(net.kdt.pojavlaunch.firefly.utils.MathUtils.dist(
