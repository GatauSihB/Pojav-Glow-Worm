...
import static net.kdt.pojavlaunch.firefly.prefs.LauncherPreferences.PREF_VIRTUAL_MOUSE_START;
...
import net.kdt.pojavlaunch.firefly.customcontrols.CustomControls;
import net.kdt.pojavlaunch.firefly.customcontrols.EditorExitable;
import net.kdt.pojavlaunch.firefly.customcontrols.keyboard.LwjglCharSender;
import net.kdt.pojavlaunch.firefly.customcontrols.keyboard.TouchCharInput;
import net.kdt.pojavlaunch.firefly.customcontrols.mouse.GyroControl;
import net.kdt.pojavlaunch.firefly.customcontrols.mouse.HotbarView;
import net.kdt.pojavlaunch.firefly.customcontrols.mouse.Touchpad;
import net.kdt.pojavlaunch.firefly.lifecycle.ContextExecutor;
import net.kdt.pojavlaunch.firefly.prefs.LauncherPreferences;
import net.kdt.pojavlaunch.firefly.services.GameService;
