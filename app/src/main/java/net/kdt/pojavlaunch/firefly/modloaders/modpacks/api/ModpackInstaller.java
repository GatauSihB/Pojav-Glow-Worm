package net.kdt.pojavlaunch.firefly.modloaders.modpacks.api;
...
import net.kdt.pojavlaunch.firefly.modloaders.modpacks.models.ModDetail;
import net.kdt.pojavlaunch.firefly.progresskeeper.DownloaderProgressWrapper;
